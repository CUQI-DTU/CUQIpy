...
If you have used implicit priors of CUQIpy in your research, we kindly ask you to also cite the following paper:
...
Here we also keep a collection of papers that use CUQIpy. If your paper should be included, please open an issue or pull request.
