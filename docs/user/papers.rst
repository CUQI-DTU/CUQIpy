...
Here we keep a collection of papers that use CUQIpy. If your paper should be included, please open an issue or pull request.
...
- Add one short topic tag per paper to improve scanning.
