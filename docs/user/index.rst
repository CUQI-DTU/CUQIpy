...
- :doc:`Background <background/index>`
   To understand how CUQIpy works. Are you interested in how CUQIpy works? This section contains information about the underlying mathematics, theory and computational algorithms used in CUQIpy.

- :doc:`API Reference <../api/index>`
   To see documentation of the CUQIpy API. This contains an overview of all the modules, classes and functions in CUQIpy.
