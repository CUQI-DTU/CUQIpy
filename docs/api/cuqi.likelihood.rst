...
The :class:`cuqi.likelihood.Likelihood` represents the likelihood function commonly used in conjunction with a prior to define a :class:`cuqi.distribution.Posterior` or :class:`cuqi.problem.BayesianProblem`.
