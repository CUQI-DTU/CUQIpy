...
# define model 
model = cuqi.model.Abel_1D(N=N, L=L, field_type=None, KL_map=KL_map)
...
d_KL = 150
model = cuqi.model.Abel_1D(N=N, L=L, field_type='CustomKL', \
...
model = cuqi.model.Abel_1D(N=N, L=L, field_type='Step', KL_map=KL_map)
x = model.domain_geometry.grid
#
