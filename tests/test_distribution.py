...
@pytest.mark.parametrize("mean,std,R,expected",[
                        ...
                        np.array([[ 1. , -0.7],
                                [-0.7,  1. ]]),
                        np.array([[-1.47139568, -0.03445763, -2.10030149, -0.93455864,  0.2541872 ],
                        ...
                        np.array([[ 1.   ,  0.001],
                                [-0.001,  1.   ]]),
                        np.array([[-1.88998123,  3.89532175, -6.21764722, -3.62006864, -1.85133578],
                                [90.43876395, 51.17340778, 95.61377534, 49.74045909, -2.92479388]])),

                        (np.array([23.        ,  0.        ,  3.14159265]),
                        np.array([3.        , 1.41421356, 3.14159265]),
                        np.array([[ 1. ,  0.9,  0.3],
                                [ 0.9,  1. ,  0.5],
                                [-0.3, -0.5,  1. ]]),
                        np.array([[18.09724511, 16.68961957, 20.05485545, 22.20383097, 20.87158838],
