...
class Conjugate: # TODO: Subclass from Sampler once updated
    ...
    def __init__(self, target: Posterior):
        ...
        if isinstance(target.likelihood.distribution, (RegularizedGaussian, RegularizedGMRF)) and target.likelihood.distribution.preset is not None and target.likelihood.distribution.preset["constraint"] not in ["nonnegativity"]:
