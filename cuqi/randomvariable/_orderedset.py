class OrderedSet:
    ...
    def extend(self, other):
        ...
        Raises a TypeError if the other object is not an OrderedSet.
        """
        if not isinstance(other, OrderedSet):
            raise TypeError("unsupported operand type(s) for extend: 'OrderedSet' and '{}'".format(type(other).__name__))
        for item in other:
            self.add(item)
    ...
    def __or__(self, other):
        ...
        """
        if not isinstance(other, OrderedSet):
            raise TypeError("unsupported operand type(s) for |: 'OrderedSet' and '{}'".format(type(other).__name__))
        new_set = OrderedSet(self.dict.keys())
