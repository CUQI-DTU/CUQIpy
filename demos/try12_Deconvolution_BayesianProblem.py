...
TP = cuqi.testproblem.Deconvolution2D(dim=dim, phantom="cat")
...
#TP.prior = Cauchy_diff(location=np.zeros(n), scale=0.1, bc_type="zero", physical_dim=ndim, geometry=TP.model.domain_geometry) #NUTS is not adapting parameters fully. (Not using sample(n,nb) atm.)
