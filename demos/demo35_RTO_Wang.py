...
plt.plot(x_chain_prop[:, 0], x_chain_prop[:, 1], 'ro', fillstyle='none', markersize=3)
plt.plot(x_chain[:, 0], x_chain[:, 1], 'k.', markersize=1.5)
plt.plot(mu[0], mu[1], 'b*', fillstyle='none', markersize=7)
plt.xlim(-2, 2)
plt.ylim(-1, 2)
