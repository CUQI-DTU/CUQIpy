...
MH_sampler.warmup(100)
MH_sampler.sample(1000)
MH_samples = MH_sampler.get_samples()
plt.figure()
...
try:
    ...
    MALA_sampler.warmup(1000)
    MALA_samples = MALA_sampler.get_samples()
...
posterior.enable_FD()
MALA_sampler = cuqi.sampler.MALA(posterior, 0.0001)
MALA_sampler.warmup(10)
MALA_sampler.sample(1000)
MALA_samples = MALA_sampler.get_samples()
plt.figure()
...
ULA_sampler.warmup(10)
ULA_sampler.sample(1000)
...
NUTS_sampler.warmup(10)
NUTS_sampler.sample(1000)
NUTS_samples = NUTS_sampler.get_samples()
plt.figure()
