...
MH_sampler = cuqi.legacy.sampler.MH(posterior)
...
try:
    MALA_sampler = cuqi.legacy.sampler.MALA(posterior, 0.0001)
...
ULA_sampler = cuqi.legacy.sampler.ULA(posterior, 0.0001)
...
NUTS_sampler = cuqi.legacy.sampler.NUTS(posterior)
